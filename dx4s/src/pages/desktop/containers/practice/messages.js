export default {
  ...
  packUpThePanel: { id: 'app.practice.packUpThePanel', en: 'Hide the answer card', zh: '收起答题卡' },
  viewPanel: { id: 'app.practice.viewPanel', en: 'Show the answer card', zh: '展开答题卡' },
  mistakes: { id: 'app.practice.review.mistakes', en: 'All the mistakes', zh: '只看错题' },
  oneMoreTime: { id: 'app.practice.review.oneMoreTime', en: 'Come on, you can do better!', zh: '差一点！继续加油！' },
  oneMoreTimeBtn: { id: 'app.practice.review.oneMoreTimeBtn', en: 'Practice again', zh: '再练习一次' },
};
