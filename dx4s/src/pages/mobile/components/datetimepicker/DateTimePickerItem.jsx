...
class DatePickerItem extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    const notEqualTime = nextProps.value.getTime() !== this.props.value.getTime();
    return notEqualTime || !shallowEqual(nextState, this.state);
  }
  ...
  _moveToNext(direction) {
    ...
    // console.log(date.getTime(), min.getTime());
...
DatePickerItem.propTypes = {
  ...
  min: PropTypes.object,    // eslint-disable-line
  max: PropTypes.object,    // eslint-disable-line
