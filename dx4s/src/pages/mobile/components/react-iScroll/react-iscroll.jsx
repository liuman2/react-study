...
class ReactIScroll extends Component {
  ...
  render() {
    ...
    let {pullDown, pullUp, pullDownText, pullUpText, className, style, hidePullUp} = this.props;
    ...
    return (
      <div className={`iscroll-wrapper${className}`} style={style || {}}>
        <div className="iscroll-body">
          ...
          {pullUp ? (
            <div className={classnames({'iscroll-pull-up': true, [pullUpCls]: true, 'special-pull-up': hidePullUp })}>
              <i></i>
...
ReactIScroll.propTypes = {
  ...
  hidePullUp: PropTypes.bool, //上拉加载前是否隐藏”上滑加载更多“文本
};
